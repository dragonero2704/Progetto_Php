...
INSERT INTO `genere` (`genere`, `descrizione`) VALUES
	('Avventura', 'vivi un\'avventura completando la storia ed esplorando il mondo'),
	('Fantascienza', 'esplora un mondo futuristico'),
	('Open World', 'Mappa aperta da esplorare'),
	('Prima Persona', 'Il giocatore vede il mondo con gli occhi del protagonista'),
	('RPG', 'Role Play Game'),
	('Sparatutto', 'divertiti a combattere con vari tipi di arma'),
	('Strategico', 'usa le tue capacità gestionali per vincere'),
	('Survival', 'Il giocatore accumola risorse e crea strumenti per soppravvivere e progredire'),
	('Terza Persona', 'visuale in terza persona');
...
INSERT INTO `giochi` (`codice_gioco`, `titolo`, `descrizione`, `prezzo`, `pegi`, `software_house`) VALUES
	...
	(9, 'Destiny 2', 'Destiny 2 è un MMO d\'azione con un unico mondo in continua evoluzione, accessibile ovunque, gratuitamente e in qualsiasi momento con gli amici.', 0, '16', 11),
	(10, 'Minecraft', 'Minecraft è un gioco in cui potrai costruire con i blocchi e vivere avventure.', 16.99, ' 7', 10),
	...
	(16, 'Lego star wars the skywalker saga', 'In LEGO® Star Wars™: The Skywalker Saga, la galassia è tua. Vivi momenti memorabili e azione senza fine da tutti i nove film della saga di Skywalker, reinventati nel classico umorismo LEGO.', 59.99, ' 0', 9),
	...
	(20, 'Genshin impact', 'Genshin Impact è un action RPG open world, che ruota attorno alla costruzione ed all\'uso sinergico di un gruppo di quattro elementi, scelti tra i numerosi personaggi disponibili', 0, '12', 8),
	...
	(22, 'Among us', 'La vita di un astronauta: completa tutti gli incarichi per vincere, ma fai attenzione agli impostori! Segnala i cadaveri e convoca riunioni d\'emergenza per espellere gli impostori. Scegli con attenzione!', 0, ' 0', 7),
	(23, 'Stranger of paradise final fantasy', 'In questo GDR d\'azione duro e puro, Jack affronta numerose sfide per restituire la luce ai Cristalli di Cornelia, regno invaso dall\'oscurità.', 59.99, '16', 2),
	...
	(25, 'Rocket league', 'Rocket League è un ibrido arcade che unisce il calcio a una frenetica scorrazzata di veicoli potentissimi, con comandi semplici e gare basate sulle leggi della fisica.', 0, '12', 7);
...
-- Dump dei dati della tabella php_gamestore.motivazione_pegi: ~40 rows (circa)
...
INSERT INTO `motivazione_pegi` (`codice_gioco`, `motivazione`) VALUES
	...
	(6, 'paura'),
	(6, 'violenza'),
	(7, 'linguaggio scurrile'),
	(7, 'online'),
	(7, 'violenza'),
	(9, 'linguaggio scurrile'),
	(9, 'paura di fare schifo'),
	(9, 'violenza'),
	(10, 'online'),
	(10, 'violenza'),
	(11, 'Linguaggio scurrile'),
	(11, 'Violenza'),
	(13, 'linguaggio scurrile'),
	(13, 'violenza'),
	(14, 'linguaggio scurrile'),
	(14, 'violenza'),
	(15, 'linguaggio scurrile'),
	(15, 'violenza'),
	(16, 'violenza'),
	(17, 'linguaggio scurrile'),
	(17, 'sesso'),
	(17, 'violenza'),
	(18, 'discriminazione'),
	(18, 'ideologie estreme'),
	(18, 'utilizzo di sostanze stupefacenti'),
	(18, 'violenza'),
	(19, 'linguaggio scurrile'),
	(19, 'sesso'),
	(19, 'utilizzo sostanze stupefacenti'),
	(19, 'violenza'),
	(20, 'violenza'),
	(21, 'linguaggio scurrile'),
	(21, 'sesso'),
	(21, 'violenza'),
	(22, 'violenza'),
	(23, 'linguaggio scurrile'),
	(23, 'violenza'),
	(24, 'utilizzo di soldi'),
	(25, 'online');
...
-- Dump dei dati della tabella php_gamestore.possiede: ~9 rows (circa)
